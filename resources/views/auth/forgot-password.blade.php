...
<html lang="en"><head>
    ...
    <link href="{{asset('Backend_assets/assets/css/authentication/form-2.css')}}" rel="stylesheet" type="text/css" />
...
<body class="form no-image-content">
    ...
    <script src="{{asset('Backend_assets/assets/js/authentication/form-2.js')}}"></script>
</body>
</html>
